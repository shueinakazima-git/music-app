...
INSERT INTO tbl_artists (artist_id, artist_name, started_at) VALUES (1, 'Michael Jackson', SYSDATE);
INSERT INTO tbl_artists (artist_id, artist_name, started_at) VALUES (2, 'David Bowie', SYSDATE);
INSERT INTO tbl_artists (artist_id, artist_name, started_at) VALUES (3, 'Freddie Mercury', SYSDATE);

-- グループ
INSERT INTO tbl_groups (group_id, group_name, formation_date) VALUES (4, 'The Beatles', SYSDATE);
INSERT INTO tbl_groups (group_id, group_name, formation_date) VALUES (5, 'Queen', SYSDATE);
INSERT INTO tbl_groups (group_id, group_name, formation_date) VALUES (6, 'Pink Floyd', SYSDATE);
...
-- アルバム
INSERT INTO tbl_albums (album_id, album_name, creator_id, release_date) VALUES (1, 'Thriller', 1, SYSDATE);

-- タグ
INSERT INTO tbl_tags (tag_id, tag_name, note, user_id, created_at) VALUES (1, 'rock', NULL, 1, SYSTIMESTAMP);
